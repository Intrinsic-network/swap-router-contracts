...
import '@intrinsic-finance/core/contracts/libraries/TickBitmap.sol';
...
contract QuoterV2 is IQuoterV2, IIntrinsicSwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IIntrinsicPool) {
        return IIntrinsicPool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IIntrinsicSwapCallback
    function intrinsicSwapCallback(
        ...
        IIntrinsicPool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IIntrinsicPool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
